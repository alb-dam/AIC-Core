"""Core pipeline: I/O Video, Threading, YOLO, Regia e VirtualDirector.

Unifica Controller, Pipeline e Regia in una singola classe compatta.
"""
...
from src.inference.roi import Detector
